...
namespace Rosneft.Domain
{
    public class AppDbContext : DbContext
    {
        ...
        public DbSet<Operations> TbOperations { get; set; }
        public DbSet<TypeOfDescentEquipment> TbTypeOfDescentEquipments { get; set; }
        public DbSet<ProtectorType> TbProtectorTypes { get; set; }
        public DbSet<PipeDiameter> TbPipeDiameters { get; set; }

        public DbSet<Hole> TbHole { get; set; }
        public DbSet<Repair> TbRepair { get; set; }
        public DbSet<RepairDescription> TbRepairDescriptions { get; set; }
